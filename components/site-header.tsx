      ...
      <header className="kanakshi-header">
        <div className="kanakshi-container">
          <div className="kanakshi-main-header">
            ...
            {/* Functional Debounced Search Bar (Desktop / Tablet) */}
            <div className="kanakshi-search-box kanakshi-desktop-search">
          ...
          <div className="kanakshi-mobile-search-row">
            <form onSubmit={handleSearchSubmit}>
              <div className="kanakshi-search-input-wrap mobile">
                <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="var(--kanakshi-text-muted)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="kanakshi-search-icon">
                  <circle cx="11" cy="11" r="8" />
                  <line x1="21" y1="21" x2="16.65" y2="16.65" />
                </svg>
                <input
                  type="text"
                  className="kanakshi-search-input"
                  placeholder="Search 925 Silver, Solitaires, Gifts..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  onFocus={() => setSearchFocused(true)}
                  onBlur={() => setTimeout(() => setSearchFocused(false), 260)}
