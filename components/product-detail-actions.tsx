...
export function ProductDetailActions({ product }: { product: Product }) {
  ...
  return (
    <div className="detail-actions-deck">
      {isSellable ? (
        <>
          {/* Primary CTA Row (Add to Bag & Buy Now) */}
          <div className="action-primary-row">
            ...
            >
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" fill="#d4af37" />
              </svg>
          ...
          {/* Secondary Actions Row (Wishlist & WhatsApp Stylist) */}
          <div className="action-secondary-row">
            ...
            >
              <svg
                ...
                stroke={isWishlisted ? "#e9718b" : "currentColor"}
                strokeWidth="2"
                strokeLinecap="round"
            ...
            >
              ...
              <span>Ask Jewellery Stylist</span>
            </a>
          </div>
        ...
        <div className="action-primary-row">
          ...
          <p className="coming-soon-note">
            This piece is currently being handcrafted in our studio.
          </p>
        </div>
      )}
    </div>
