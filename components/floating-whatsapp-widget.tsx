...
export function FloatingWhatsappWidget({ phone }: FloatingWhatsappWidgetProps) {
  ...
  return (
    <a
      href={`https://wa.me/${normalizedPhone || "918586898691"}?text=Hi%20Kanakshi%20Fine%20Jewellery%2C%20I'd%20like%20to%20inquire%20about%20your%20handcrafted%20925%20silver%20and%20gold%20jewellery.`}
      target="_blank"
      rel="noopener noreferrer"
      className="whatsapp-float-widget"
      aria-label="Chat with Kanakshi Stylist on WhatsApp"
    >
